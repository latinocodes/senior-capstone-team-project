...
public class Residence extends Lease {
    ...
    /* Constructor */
    public Residence(int residenceID, String rentCost, int leaseID, String duration, String startDate, String endDate) {
    ...
    /* Constructor */
    public Residence(int residenceID, String aptNum, String rentCost, int leaseID, String duration, String startDate,
                     String endDate, Invoice newInvoice) {
        super(leaseID, duration, startDate, endDate);
        this.residenceID = residenceID;
        this.rentCost    = rentCost;
