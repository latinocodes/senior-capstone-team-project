...
public class Invoice extends Lease {
    ...
    /* Variables */
    private String billDue, billPaid, firstNotice, lastNotice;
    ...
    /* Constructor */
    public Invoice(int invoiceID, String billDue, String billPaid, String firstNotice, String lastNotice, int leaseID,
                   int residenceID, String duration, String startDate, String endDate) {
